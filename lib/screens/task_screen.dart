...
class TaskScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Fetch the username to display in the greeting
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Obx(() => Text(
              'Hello, ${taskController.username.value} 👋',
                      ...
                      child: Obx(() {
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Dismissible(
                              key: Key(task.id), // Use index as key
                                ...
                                trailing: Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () {
                                        _showEditTaskDialog(context, taskController, index);
                                      },
                                    ),
                                  ],
                                ),
  ...
  void _showEditTaskDialog(BuildContext context, TaskController taskController, int index) {
    final TextEditingController titleController = TextEditingController(text: taskController.tasks[index].title);
    final TextEditingController descriptionController = TextEditingController(text: taskController.tasks[index].description);
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                taskController.updateTask(index, titleController.text, descriptionController.text);
                Navigator.of(context).pop();
              },
              child: Text('Update'),
            ),
...
class TaskScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    taskController.fetchUsername(); // Ensure username is fetched
